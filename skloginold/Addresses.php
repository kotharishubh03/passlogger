...
<html>
    ...
    <style>
                            ...
                            <div class="w3-container">
                                ...
                                <form class="w3-container w3-margin">
                                    ...
                                    <div class="w3-row w3-margin"> 
                                        ...
                                        <textarea class="w3-col l9 w3-input w3-border" readonly></textarea>
                                    </div >
        ...
        <script>
            ...
            function addsq() {
                if (countsq >= 4) {
                    alert("Maximum of four security Question entries exceeded");
                    return;
                }
                countPos++;
            } 
            ...
            window.console && console.log('Document ready called');
                ...
                $('#asqb').click(function (event) {
                    ...
                    $('#sq').append(
                        ...
                        '<input class="w3-col l5 w3-input w3-border" type="text">' +
                        '<label class="w3-col l1 w3-margin-left">Answer</label>' +
                        '<input class="w3-col l3 w3-input w3-border" type="text">'
                    );
                });
            });
        </script>
